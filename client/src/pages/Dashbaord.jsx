...
function Dashbaord() {
    return (
        <div className='w-full flex bg-offwhite h-screen relative'>
            <Leftsidebar />
            <div className='flex flex-grow flex-col gap-10 overflow-auto px-20 pt-32 pb-40 max-md:pb-[100px] max-md:px-5 scroll-smooth'>
