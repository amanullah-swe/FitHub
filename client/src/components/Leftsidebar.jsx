...
function Leftsidebar() {
  ...
  return (
    <div className="flex flex-col items-center max-md:justify-between  gap-20 h-full w-[180px] bg-offwhite py-24 px-7 boder border-r border-r-customgreen absolute z-50 min-md:top-0 left-0 max-md:bottom-0 max-md:flex-row max-md:w-full max-md:h-[60px] max-md:gap-5 max-md:border-t-customgreen max-md:border-t max-md:py-0  ">
      ...
      <Link
        to={"/"}
        className="flex items-center justify-center gap-4  w-56 max-md:w-fit  px-12 py-2 rounded-xl max-md:hidden"
      >
        <img
          src={logo}
          width={40}
          alt=""
        />
        <p className="logo2  flex items-end">
          Fithub <span className="span text-5xl"> .</span>
        </p>
      </Link>
      {/* home */}
      <Link
        to={"/home"}
        className="flex items-center justify-start gap-2  w-56 max-md:w-fit  border px-3 py-2 rounded-xl"
      >
        ...
        <p className="font-heading max-md:hidden font-normal text-primary">
          Home
        </p>
      </Link>
      ...
      <Link
        to={"/search"}
        className="flex items-center justify-start gap-2  w-56 max-md:w-fit  border px-3 py-2 rounded-xl max-md:hidden"
      >
      ...
      >
        <div className=" fill-customgreen">
          <svg
            ...
            viewBox="0 0 307.429 307.429"
            xmlSpace="preserve"
          >
            <g>
              <path
                d="M248.286,119.439l59.143-54.846l-14.858-14.592l-56.893,63.609c-4.115-1.638-8.516-3.176-13.185-4.6l48.447-66.076
		...
		l41.387-56.447c3.819,1.082,7.388,2.25,10.67,3.496l-46.902,52.439C168.633,186.855,166.915,187.025,165.178,187.183z
		 M176.592,185.923l50.794-47.104c8.929,4.863,14.038,10.506,14.038,16.523C241.424,169.119,214.664,180.927,176.592,185.923z"
              />
              <path
                d="M103.644,81.275c6.556,5.473,12.772,11.494,16.271,19.465c5.375,12.25,2.166,26.09-4.195,37.32
		...
		C85.087,63.468,93.925,73.158,103.644,81.275z"
              />
              <path
                d="M130.184,41.257c2.675,2.234,5.214,4.691,6.641,7.945c2.193,5,0.884,10.648-1.713,15.23c0.832,0,2.395-2.105,2.863-2.676
      ...
      <Link
        to={"/dashboard"}
        className="flex items-center justify-start gap-3 max-md:w-fit  px-3  w-56 border py-2 rounded-xl"
      >
        <div className=" fill-customgreen">
          <svg
      ...
      {auth ? (
        <Link
          to={"/signin"}
          className="flex fill-black items-center justify-center gap-2 h-16  w-58 max-md:w-[32px] max-md:h-[32px] border px-12 py-2 rounded-xl bottom-24  md:absolute"
        >
